...
use actix_web::{
    error, middleware, web, App, Error, HttpRequest, HttpResponse, HttpServer, ResponseError
};
...
async fn index_err() -> Result<web::HttpResponse, JsonError> {
    Err(JsonError {
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(|| {
        App::new()
            ...
            .service(web::resource("/err").route(web::get().to(index_err)))
